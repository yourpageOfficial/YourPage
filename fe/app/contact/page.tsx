    ...
    <>
      ...
      <PageTransition>
        <main className="mx-auto max-w-lg px-4 py-12 text-center">
          ...
          <h1 className="text-2xl font-display font-black tracking-tight">{t.contact.title}</h1>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{t.contact.subtitle}</p>
          <div className="mt-8 space-y-3">
            <Card hover><CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="text-left"><p className="font-semibold">{t.contact.emailLabel}</p><p className="text-sm text-gray-500 dark:text-gray-400">support@yourpage.id</p></div>
            </CardContent></Card>
            <Card hover><CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="text-left"><p className="font-semibold">{t.contact.whatsappLabel}</p><p className="text-sm text-gray-500 dark:text-gray-400">+62 812-xxxx-xxxx</p></div>
            </CardContent></Card>
          </div>
        </main>
      </PageTransition>
