    ...
    <AuthGuard>
      ...
      <main className="mx-auto max-w-2xl px-3 sm:px-4 py-6 sm:py-8">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" onClick={() => markAll.mutate()}>Tandai semua dibaca</Button>
        </div>
        <div className="space-y-3">
          ...
          {notifs?.length === 0 && <p className="text-sm text-gray-500 dark:text-gray-400">Belum ada notifikasi.</p>}
        </div>
      </main>
    </AuthGuard>
  );
