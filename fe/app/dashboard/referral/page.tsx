...
export default function ReferralPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-display font-black tracking-tight mb-6">Referral</h1>
      <Card className="mb-4">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium mb-1.5 block">Kode Referral</label>
          ...
          <div>
            <label className="text-sm font-medium mb-1.5 block">Link Referral</label>
            <div className="flex gap-2 mt-1">
